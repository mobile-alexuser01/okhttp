...
public final class CustomTrust {
   ...
   * certificates have not been signed by these certificates will fail with a {@link
   ...
   * not use custom trusted certificates in production without hte blessing of your server's TLS
   * administrator.
   */
